...
class DateUtil {
  ...
  ///使用:    List<String> mdata=DateUtil.instance.getTimeBettwenStartTimeAndEnd(startTime:"2019-07-11",endTime:"2019-08-29",format:"yyyy年MM月dd");
  ...
  List getTimeBettwenStartTimeAndEnd({
    startTime = String,
    endTime = String,
    format = String,
  }) {
  ...
  ///使用：DateUtil.instance.getTimeStartTimeAndEnd(startTime:"2019-07-11",dayNumber:10,format:"yyyy年MM月dd");
  ...
  ///dayNumber:时间段
  ///输入时间格式
  List getTimeStartTimeAndEndTime({
    startTime = int,
    dayNumber = int,
    format = String,
  }) {
