class WoDePingLunBean {
  final int? state;
  final String? message;
  final Data? data;

  WoDePingLunBean({this.state, this.message, this.data});

  factory WoDePingLunBean.fromJson(Map<String, dynamic> json) {
    return WoDePingLunBean(
...
class Data {
  final int? total;
  final List<PingLunContent>? content;
    ...
    return Data(
      ...
      content: json['content'] != null
          ? (json['content'] as List)
                .map((v) => PingLunContent.fromJson(v))
                .toList()
          : null,
    );
  }
...
class PingLunContent {
  ...
  factory PingLunContent.fromJson(Map<String, dynamic> json) {
